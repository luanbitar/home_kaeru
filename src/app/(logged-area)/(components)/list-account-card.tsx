...
export function ListAccountCard({ account }: { account: any }) {
  return (
    <CardContainer className="flex w-full flex-1" translateZ={12}>
      <CardBody className="group/card relative h-auto w-full rounded-xl border border-black/[0.1] p-6 dark:border-white/[0.2] dark:hover:shadow-2xl dark:hover:shadow-primary/[0.1]">
